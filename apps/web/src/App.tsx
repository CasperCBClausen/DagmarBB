...
const RoomsPage = React.lazy(() => import('./pages/guest/RoomsPage'));
const RoomDetailPage = React.lazy(() => import('./pages/guest/RoomDetailPage'));
    ...
    <>
      <Suspense fallback={
        ...
        <Routes>
          ...
          <Route path="/book/:roomSlug" element={<BookingPage />} />
